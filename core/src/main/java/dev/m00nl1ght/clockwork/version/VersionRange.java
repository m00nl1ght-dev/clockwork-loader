...
public class VersionRange {
    ...
    public boolean isSatisfiedBy(Version version) {
        return switch (this.op) {
            case EQ -> version.isEquivalentTo(this.version);
            case LT -> version.isLowerThan(this.version);
            case LTE -> version.isLowerThan(this.version) || version.isEquivalentTo(this.version);
            case GT -> version.isGreaterThan(this.version);
            case GTE -> version.isGreaterThan(this.version) || version.isEquivalentTo(this.version);
