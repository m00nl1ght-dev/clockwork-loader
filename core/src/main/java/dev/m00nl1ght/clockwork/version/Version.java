...
public final class Version implements Comparable<Version> {
    ...
    public boolean satisfies(String requirement) {
        return this.satisfies(switch (this.type) {
            case STRICT -> VersionRequirement.buildStrict(requirement);
            case LOOSE -> VersionRequirement.buildLoose(requirement);
            case IVY -> VersionRequirement.buildIvy(requirement);
